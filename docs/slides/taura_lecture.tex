...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
      \includegraphics[width=\textwidth]{out/pdf/svg/diagram_cpu_gpu_1.pdf}
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.5\textwidth}
      \only<1>{\includegraphics[width=\textwidth]{out/pdf/svg/diagram_cpu_gpu_1.pdf}}%
      \only<2>{\includegraphics[width=\textwidth]{out/pdf/svg/diagram_cpu_gpu_2.pdf}}%
      \only<3->{\includegraphics[width=\textwidth]{out/pdf/svg/diagram_cpu_gpu_3.pdf}}%
    \end{column}
  \end{columns}
\end{frame}
...
\begin{center}
\only<1>{\includegraphics[width=0.6\textwidth]{out/pdf/svg/latency_1.pdf}}%
\only<2->{\includegraphics[width=0.6\textwidth]{out/pdf/svg/latency_2.pdf}}
\end{center}
\end{frame}
...
\begin{center}
\only<1>{\includegraphics[width=0.6\textwidth]{out/pdf/svg/latency_3.pdf}}%
\only<2->{\includegraphics[width=0.6\textwidth]{out/pdf/svg/latency_2.pdf}}
\end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\textwidth}
      \only<1>{\includegraphics[width=\textwidth]{out/pdf/svg/diagram_gpu_concepts_1.pdf}}%
      \only<2>{\includegraphics[width=\textwidth]{out/pdf/svg/diagram_gpu_concepts_2.pdf}}%
      \only<3>{\includegraphics[width=\textwidth]{out/pdf/svg/diagram_gpu_concepts_3.pdf}}%
      \only<4>{\includegraphics[width=\textwidth]{out/pdf/svg/diagram_gpu_concepts_4.pdf}}%
    \end{column}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{columns}
    ...
    \end{column}
    \begin{column}{0.6\textwidth}
      \includegraphics[width=\textwidth]{out/pdf/svg/diagram_gpu_concepts_5.pdf}
    \end{column}
  \end{columns}
\end{frame}
...
%Intel IceLake Platinum 8380 & 2.9 & 5.9  & $\approx$ 270W \\
...
\begin{frame}[fragile]
  \frametitle{生成されたアセンブリコードを見る}
  \begin{itemize}
  \item 多くのコンパイラは\ao{\texttt{-S}}オプションで,
    アセンブリコード(\ao{\texttt{.s}})を生成
